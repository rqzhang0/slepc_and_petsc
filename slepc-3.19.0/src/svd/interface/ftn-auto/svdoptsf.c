...
SLEPC_EXTERN void  svdsetproblemtype_(SVD svd,SVDProblemType *type, int *__ierr)
{
*__ierr = SVDSetProblemType(
	(SVD)PetscToPointer((svd) ),*type);
}
SLEPC_EXTERN void  svdgetproblemtype_(SVD svd,SVDProblemType *type, int *__ierr)
{
*__ierr = SVDGetProblemType(
	(SVD)PetscToPointer((svd) ),type);
}
SLEPC_EXTERN void  svdisgeneralized_(SVD svd,PetscBool* is, int *__ierr)
{
*__ierr = SVDIsGeneralized(
	(SVD)PetscToPointer((svd) ),is);
}
SLEPC_EXTERN void  svdishyperbolic_(SVD svd,PetscBool* is, int *__ierr)
{
*__ierr = SVDIsHyperbolic(
	(SVD)PetscToPointer((svd) ),is);
}
