...
SLEPC_EXTERN void  peplinearsetexplicitmatrix_(PEP pep,PetscBool *explicitmat, int *__ierr)
{
*__ierr = PEPLinearSetExplicitMatrix(
	(PEP)PetscToPointer((pep) ),*explicitmat);
}
SLEPC_EXTERN void  peplineargetexplicitmatrix_(PEP pep,PetscBool *explicitmat, int *__ierr)
{
